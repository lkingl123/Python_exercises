...
class Parts(db.DBbase):
    ...
    def delete(self, part_id):
        try:
            ...
            super().get_connection.commit()
            print(f"Deleted part ID: {part_id} sucessfully.")
            return True
        except Exception as e:
            print("An error has occurred.", e)
            return False
        ...
        try:
            ...
            try:
                ...
                if part_id is not None:
                    ...
                    INSERT INTO Inventory (part_id, quantity, price) VALUES (?,?,?); """, (part_id[0], qty, price))
                    super().get_connection.commit()
    ...
    def fetch_inv(self, id=None):
        try:
            if id is not None:
                ...
                return super().get_cursor.execute("""SELECT Inventory.id, part_id, p.name, quantity, price FROM Inventory JOIN
                 Parts p on Inventory.part_id = p.id;""").fetchall()
        except Exception as e:
            print("An error occurred.", e)
    ...
    def run(self):
        ...
        while user_selection != "exit":
            ...
            if user_selection == "get":
                ...
                confirm = input("This will delete on records in parts and inventory, continue? (y/n) ").lower()
                if confirm == "y":
